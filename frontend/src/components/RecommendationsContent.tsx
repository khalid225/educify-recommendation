	...
	return (
		<div className="text-center">
			...
			<div className="border-2 border-dashed border-gray-300 rounded-lg p-4 mb-4">
				<h2 className="text-lg font-semibold text-gray-900 mb-4">Ask for recommendations via:</h2>

				<div className="flex justify-center space-x-4 mb-4">
					{shareButtons.map((button) => (
						<button
							key={button.name}
							className={`${button.color} text-white px-4 py-2 rounded-full font-medium flex items-center space-x-2 transition-colors`}>
			...
			<div className="max-w-md mx-auto">
				...
				<div className="flex">
					<input
						...
						readOnly
						className="flex-1 px-3 py-1.5 border border-gray-300 rounded-l-full bg-gray-50 text-gray-900"
					/>
					<button
						onClick={copyLink}
						className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-r-full font-medium flex items-center space-x-2 transition-colors">
